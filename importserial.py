...
import time             
##from msvcrt import getch                                                   #Required to use delay functions   
ArduinoUnoSerial = serial.Serial('/dev/cu.usbmodem1411') 
print(ArduinoUnoSerial.name)      #Create Serial port object called ArduinoUnoSerialData time.sleep(2)                                                             #wait for 2 secounds for the communication to get established
